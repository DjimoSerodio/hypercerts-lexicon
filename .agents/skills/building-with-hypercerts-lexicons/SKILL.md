...
| Lexicon     | NSID                            | Purpose                                                                                                                                                                 |
| ----------- | ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Feature** | `org.hypercerts.entity.feature` | Subject record for non-agent things claims describe (zones, strata): identity, `description`, governed `tags`, optional `locations`, entity-level `sameAs`, `createdAt` |

### General Tags

| Lexicon | NSID                       | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------- | -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Tag** | `org.hypercerts.vocab.tag` | Governed vocabulary term with stable `key`, display `name`, category, optional `description`, `status` lifecycle, `supersededBy`, aliases, exact-match `sameAs` crosswalks, optional `broader` strong references to one or more directly broader terms, an optional `referenceDocument` URI or attached small blob that defines or motivates the term, and `createdAt`; referenced by `collection.tags` and `feature.tags` |
